var objs = []
var crashloc
var canvdim = [Math.floor(window.innerWidth / 100) * 100 || Math.floor(document.body.clientWidth / 100) * 100, window.innerHeight - 25 || document.body.clientHeight - 25] // set canvas resolution
